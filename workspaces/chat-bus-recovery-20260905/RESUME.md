...
- No direct conversation-send action was exposed in this runtime; GitHub Bus history remains the coordination record.
- WIP operation `op-000001` is complete through `VERIFIED`.

## Already done

- Created isolated recovery branch `wip/chat-bus-recovery-20260905-v2`.
- Saved the Chat Bus frontier and activation gates.
- Recorded the PR #21 coordination note.
- Verified the WIP records and registry entry.
